...
;Readjust VRAM transfer of equipment screen
...
;BUG:
;	vertical scrolling buggy
;	- test fixes with kraid and ridley
...
;---------------------------------------------------------------------------------------------------
{
;Use remaining freespace for sprite data of gray doors
...
GreyDoor_TopDobble: DW $0001, $0000 : DB $FB : DW $2497
GreyDoor_BottomDobble: DW $0001, $0000 : DB $03 : DW $A497
GreyDoor_LeftDobble: DW $0001, $01FC : DB $FF : DW $24A7
GreyDoor_RightDobble: DW $0001, $0004 : DB $FF : DW $64A7


DoorCapAreaEntryRange:
	DW !DoorBit_Crateria_Start, !DoorBit_Crateria_End
	DW !DoorBit_Brinstar_Start, !DoorBit_Brinstar_End
	DW !DoorBit_Norfair_Start, !DoorBit_Norfair_End
	DW !DoorBit_WreckedShip_Start, !DoorBit_WreckedShip_End
	DW !DoorBit_Maridia_Start, !DoorBit_Maridia_End
	DW !DoorBit_Tourian_Start, !DoorBit_Tourian_End
	DW !DoorBit_Ceres_Start, !DoorBit_Ceres_End
	DW !DoorBit_Debug_Start, !DoorBit_Debug_End
...
ORG $82C639
	...
	DW RedDoor_TopDobble, RedDoor_BottomDobble, RedDoor_LeftDobble, RedDoor_RightDobble
	DW GreenDoor_TopDobble, GreenDoor_BottomDobble, GreenDoor_LeftDobble, GreenDoor_RightDobble
	DW YellowDoor_TopDobble, YellowDoor_BottomDobble, YellowDoor_LeftDobble, YellowDoor_RightDobble
	DW GreyDoor_TopDobble, GreyDoor_BottomDobble, GreyDoor_LeftDobble, GreyDoor_RightDobble
...
RedDoor_TopDobble: DW $0001, $0000 : DB $FB : DW $2494
RedDoor_BottomDobble: DW $0001, $0000 : DB $03 : DW $A494
RedDoor_LeftDobble: DW $0001, $01FC : DB $FF : DW $24A4
RedDoor_RightDobble: DW $0001, $0004 : DB $FF : DW $64A4

GreenDoor_TopDobble: DW $0001, $0000 : DB $FB : DW $2495
GreenDoor_BottomDobble: DW $0001, $0000 : DB $03 : DW $A495
GreenDoor_LeftDobble: DW $0001, $01FC : DB $FF : DW $24A5
GreenDoor_RightDobble: DW $0001, $0004 : DB $FF : DW $64A5

YellowDoor_TopDobble: DW $0001, $0000 : DB $FB : DW $2496
YellowDoor_BottomDobble: DW $0001, $0000 : DB $03 : DW $A496
YellowDoor_LeftDobble: DW $0001, $01FC : DB $FF : DW $24A6
YellowDoor_RightDobble: DW $0001, $0004 : DB $FF : DW $64A6
